function compute()
{
    ...
    else
    {
        ...
        document.getElementById("result").innerHTML="If you deposit\<span>\ "+principal+" \</span>\,\<br\>at an interest rate of \<span>\ "+rate+" \</span>\%\<br\>You will receive an amount of \<span>\ "+amount+",\</span>\<br\>in the year \<span>\ "+year+"\</span>\.\<br\>"
    }
